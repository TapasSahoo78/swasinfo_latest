...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Users') }}</a>
</li>
@endsection
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">No of Users : {{ count($users) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-4 right_btn">
                    <a class="btn btn-primary" href="{{ route('admin.invitation.create') }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($user->id!=1)
                                        ...
                                        <a href="javascript:void(0)" data-value="0" data-table="users" data-message="inactive" data-uuid="{{ $user->uuid }}" class="active-status changeUserStatus text-success">Active</a>
                                        @break

                                        @case(0)
                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $user->uuid }}" data-table="users" data-message="active" class="inactive-status changeUserStatus">Inactive</a>
                                        @break
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('admin.user.edit', $user->uuid) }}">Edit</a>

                                                <a class="dropdown-item deleteData" data-table="users" data-uuid="{{ $user->uuid }}" href="javascript:void(0)">Delete</a>
                                                <?php if($user->roles()->first()->name == "Sub Admin"){?>
                                                <a href="#" class="btn btn-qr" data-toggle="modal" data-target="#generateQRModal{{ $user->uuid }}">Generate QR
                                                </a>
                                                <?php } ?>
                                            </div>
                                            @endif
                                ...
                                <div class="modal fade" id="generateQRModal{{ $user->uuid }}" tabindex="-1" role="dialog" aria-labelledby="generateQRModalTitle" aria-hidden="true">
