<<<<<<<< HEAD:resources/views/admin/brand/index.blade.php
@extends('admin.layouts.app')
========
@extends('restaurant.layouts.app')
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/restaurant/category-product/index.blade.php
@push('style')
...
<<<<<<<< HEAD:resources/views/admin/brand/index.blade.php
                        <a class="btn btn-primary" href="{{ route('admin.product.brand.add') }}">
                            ...
                            ADD BRAND
========
                        <a class="btn btn-primary" href="{{ route('restaurant.product.create') }}">
                            <span><i class="fa fa-plus" aria-hidden="true"></i></span>
                            ADD PRODUCT
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/restaurant/category-product/index.blade.php
                        </a>
...
========
                                            <td><img src="{{ asset('images/' . $value->category_image) }}" alt="Your Image" width="200" height="100">
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/restaurant/category-product/index.blade.php
                                            <td>
