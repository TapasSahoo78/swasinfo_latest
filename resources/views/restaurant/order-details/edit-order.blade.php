    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.subscription.category.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.subscription.category.edit', $categoryData->uuid) }}"
                        id="customerForm" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="category_name" class="form-control" type="text" name="category_name"
                                        placeholder="Category" value="{{ $categoryData->category_name }}" />
                                    @error('category_name')
