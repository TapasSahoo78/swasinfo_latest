...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">Edit Diet</h1>
                </div><!-- /.col -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.diet.plan.edit', $data->uuid) }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="radio" id="gender1" name="gender" value="male"@if($data->gender=="male") checked  @endif>
                                <label for="vehicle1"> Male</label>
                                <input type="radio" id="gender2" name="gender" value="female"@if($data->gender=="female") checked  @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-control" name="age_from" id="age_from">
                                            ...
                                            <option value="{{ $fromAge }}"@if($data->age_from==$fromAge) selected  @endif>{{ $fromAge }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('age_from')
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="age_to" id="age_from">
                                            ...
                                            <option value="{{ $toAge }}"@if($data->age_to==$toAge) selected  @endif>{{ $toAge }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('age_to')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-control" name="height_from" id="height_from">
                                            ...
                                            <option value="{{ $fromHeight }}"@if($data->height_from==$fromHeight) selected  @endif>{{ $fromHeight }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('height_from')
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="height_to" id="height_to">
                                            ...
                                            <option value="{{ $toHeight }}"@if($data->height_to==$toHeight) selected  @endif>{{ $toHeight }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('height_to')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-control" name="weight_from" id="weight_from">
                                            ...
                                            <option value="{{ $fromWeight }}"@if($data->weight_from==$fromWeight) selected  @endif>{{ $fromWeight }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('weight_from')
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="weight_to" id="weight_to">
                                            ...
                                            <option value="{{ $toWeight }}"@if($data->weight_to==$toWeight) selected  @endif>{{ $toWeight }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                        @error('weight_to')
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="bmi_from" class="form-control" type="text" name="bmi_from" placeholder="BMI" value="{{ $data->bmi_from }}" />
                                @error('bmi_from')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="goal">
                                        ...
                                        <option value="muscle_gain"@if($data->goal=="muscle_gain") selected  @endif>MUSCLE GAIN</option>
                                        <option value="fat_loss"@if($data->goal=="fat_loss") selected  @endif>FAT LOSS</option>
                                    </select>
                                    @error('goal')
                                        <span class="text-danger text-sm">
                                            {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="diet">
                                        ...
                                        <option value="veg"@if($data->diet=="veg") selected  @endif>VEG</option>
                                        <option value="non_veg"@if($data->diet=="non_veg") selected  @endif>NON-VEG</option>
                                    </select>
                                    @error('diet')
                                            <span class="text-danger text-sm">
                                                {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="medical_condition">
                                        ...
                                        <option value="asthma"@if($data->medical_condition=="asthma") selected  @endif>ASTHMA</option>
                                        <option value="bp"@if($data->medical_condition=="bp") selected  @endif>BP</option>
                                        <option value="joint"@if($data->medical_condition=="joint") selected  @endif>JOINT</option>
                                        <option value="pcos"@if($data->medical_condition=="pcos") selected  @endif>PCOS</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="allergy">
                                        ...
                                        <option value="gluten"@if($data->allergy=="gluten") selected  @endif>GLUTEN</option>
                                        <option value="lactose"@if($data->allergy=="lactose") selected  @endif>LACTOSE</option>
                                    </select>
                                    @error('allergy')
                                            <span class="text-danger text-sm">
                                                {{ $message }}
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="breakfast[]" id="" value="{{ $breakfast->id }}"@if ($data->breakfasts->pluck('id')->contains($breakfast->id)) checked @endif><span class="m-2">{{ $breakfast->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="optionalbreakfast[]" id="" value="{{ $optionalBreakfast->id }}"@if ($data->dietAnyBreakfasts->pluck('id')->contains($optionalBreakfast->id)) checked @endif><span class="m-2">{{ $optionalBreakfast->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="lunch[]" id="" value="{{ $lunch->id }}"@if ($data->lunches->pluck('id')->contains($lunch->id)) checked @endif><span class="m-2">{{ $lunch->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="optionallunch[]" id="" value="{{ $lunchOptional->id }}"@if ($data->dietAnyLunches->pluck('id')->contains($lunchOptional->id)) checked @endif><span class="m-2">{{ $lunchOptional->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="dinner[]" id="" value="{{ $dinner->id }}"@if ($data->dinners->pluck('id')->contains($dinner->id)) checked @endif><span class="m-2">{{ $dinner->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="optionaldinner[]" id="" value="{{ $dinnerOptional->id }}"@if ($data->dietAnyDinners->pluck('id')->contains($dinnerOptional->id)) checked @endif><span class="m-2">{{ $dinnerOptional->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="snack[]" id="" value="{{ $snack->id }}"@if ($data->snacks->pluck('id')->contains($snack->id)) checked @endif><span class="m-2">{{ $snack->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="optionalsnack[]" id="" value="{{ $snackOptional->id }}"@if ($data->dietAnySnacks->pluck('id')->contains($snackOptional->id)) checked @endif><span class="m-2">{{ $snackOptional->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
