        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Foods : {{ count($foods) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.diet.food.add') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($foods as $data)
                                        <tr>
                                            <td>{{ $data->name ? $data->name : '---' }}</td>
                                            <td>{{ $data->food_type ? $data->food_type : '---' }}</td>
                                            @if($data->lunch_image)
                                            <td><img class="ml-1" src="{{ $data->lunch_image }}" width="20"
                                                height="20" alt="Icon 01" /></td>
                                                @else
                                                <td>No Images</td>
                                            ...
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="food"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $data->uuid }}"
                                                            data-table="food" data-message="active"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.diet.edit.food', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item" href="{{ route('admin.diet.view.food.details', $data->uuid) }}">Food Details</a>
                                                            <a class="dropdown-item deleteData" data-table="food"
                                                                data-uuid="{{ $data->uuid }}"
            ...
            buttons: [
                    {
                        ...
                        text: 'Export CSV',
                        exportOptions: {
                            columns: [0,1,2,3,4,5] // Define which columns to export (e.g., columns 0 and 2)
                        },
