...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.diet.create.food.details', ['uuid' => $uuid]) }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="food_id" id="food_id" value="{{$uuid}}">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Name<sup>*</sup></label>
                                <input id="food_name" class="form-control" type="text" name="food_name" placeholder="Food Name" value="{{ old('food_name') }}" />
                                @error('food_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Food Details Image<sup>*</sup></label>
                                <input id="food_details_image" class="form-control" type="file" name="food_details_image" accept="image/jpeg,image/png,image/jpg,image/gif" />
                                @error('food_details_image')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                                @enderror
