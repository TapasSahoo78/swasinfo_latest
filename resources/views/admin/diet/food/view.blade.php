...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('FOOD DETAILS') }}</a>
</li>
@endsection
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">No of Foods Details : {{ count($foodDetails) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-4 right_btn">
                    <a class="btn btn-primary" href="{{ route('admin.diet.create.food.details', ['uuid' => $uuid]) }}">
                ...
                <div class="col-12">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 700px;">
                        <table class="table  text-nowrap custom-data-table" id="dataTable">
                            ...
                            <tbody>
                                @forelse ($foodDetails as $data)
                                <tr>
                                    <td>{{ $data->food_name ? $data->food_name : '---' }}</td>
                                    <td><img class="ml-1" src="{{ $data->details_image }}" width="20" height="20" alt="Icon 01" /></td>
