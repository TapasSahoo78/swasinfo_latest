...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Breakfast') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Courses : {{ count($breakfasts) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.diet.breakfast.add') }}">
                                    ...
                                    @forelse ($breakfasts as $data)
                                        <tr>
                                            ...
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="breakfasts"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $data->uuid }}"
                                                            data-table="breakfasts" data-message="active"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.diet.breakfast.edit', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item deleteData" data-table="breakfasts"
                                                                data-uuid="{{ $data->uuid }}"
