...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.product.edit', $productData->uuid) }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="category_id" class="form-control" name="category_id">
                                    ...
                                    <option value="{{ $category->id }}" @if (old('category_id')==$category->id || $productData->category_id == $category->id) selected @endif">
                                        {{ $category->name }}
                                    </option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="yes" @if (old('is_featured') == 'yes' || $productData->is_featured == 'yes') selected @endif>Featured</option>
                                <option value="no" @if (old('is_featured') == 'no' || $productData->is_featured == 'no') selected @endif>Not Featured
                                </option>
                            </select>
                            @error('is_featured')
                                <div class="text-xs mt-1 text-rose-500">
