        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Offers : {{ count($listOffers) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.offer.add') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($listOffers as $data)
                                        <tr>
                                            <td>{{ $data->name ? $data->name : '---' }}</td>
                                            <td>{{ $data->price ? $data->price : '---' }}</td>
                                            <td>{{ $data->persantage ? $data->persantage : '---' }}</td>
