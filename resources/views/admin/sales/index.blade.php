...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Sales List') }}</a>
</li>
@endsection
@section('content')
<style>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">No of Sales Manager: {{ count($users) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-4 right_btn">
                    <a class="btn btn-primary" href="{{ route('admin.sales.add') }}">
    ...
    <div class="content">
                                ...
                                <?php } else { ?>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <th>Mobile</th>
                                            <th id="profileImageColumn">Profile Image</th>
                                            <th>Created On</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @default
                                                <a href="javascript:void(0)" class="badge badge-danger text-dark">Deleted</a>
                                                @endswitch
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="{{ route('admin.agent.reporttotal', $data->uuid) }}">Report</a>
                                                        <a class="dropdown-item" href="{{ route('admin.sales.edit', $data->uuid) }}">Edit</a>
                                                        <a class="dropdown-item deleteData" data-table="users" data-uuid="{{ $data->uuid }}" href="javascript:void(0)">Delete</a>
                                                        <a href="#" class="btn btn-qr" data-toggle="modal" data-target="#generateQRModals{{ $data->uuid }}">Generate QR
                                                        </a>
                                        ...
                                        <div class="modal fade" id="generateQRModals{{ $data->uuid }}" tabindex="-1" role="dialog" aria-labelledby="generateQRModalTitle" aria-hidden="true">
        ...
        margin: auto;">
                                                                ...
                                                                $datas = url('/home') . '/' . $data->id;
                                                                ?>
                                                                {!! DNS2D::getBarcodeHTML($datas, 'QRCODE', 6, 6, 'black', true) !!}
                                                                <br>
                                                                <a id="shareButton" class="btn btn-primary" href="{{ route('admin.agent.qrpage', $data->id) }}">
...
<script>
    $(document).ready(function() {
        ...
        // Replace '#dataTable' with your table ID or selector

        // Get the column index of the "Profile Image" column (index starts from 0)
        ...
        var dataTable = $('#dataTable').DataTable({ // Enable search
            ...
            buttons: [{
                    ...
                    text: 'Export CSV',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6] // Define which columns to export (e.g., columns 0 and 2)
                    },
        ...
        $('#dataTable thead th:eq(' + profileImageColumnIndex + ')').removeClass('sorting sorting_asc sorting_desc');
