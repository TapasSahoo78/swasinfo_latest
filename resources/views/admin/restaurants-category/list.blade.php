...
<<<<<<<< HEAD:resources/views/admin/gym/category/list.blade.php
...
========
                    <?php if(auth()->user()->id == 1){ ?>
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.restaurant.category.add') }}">
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/admin/restaurants-category/list.blade.php
...
========
                                            ...
                                            {{-- <td>{{ $data->parent?->name ? $data->parent?->name : '---' }} --}}
...
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/admin/restaurants-category/list.blade.php
                                            ...
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
<<<<<<<< HEAD:resources/views/admin/gym/category/list.blade.php
                                                        <a href="javascript:void(0)" data-value="0" data-table="plan_categories"
========
                                                        <a href="javascript:void(0)" data-value="0" data-table="restaurants_categories"
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/admin/restaurants-category/list.blade.php
...
========
                                                            data-table="restaurants_categories" data-message="active"
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/admin/restaurants-category/list.blade.php
...
========
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.subscription.category.edit', $data->uuid) }}">Edit</a>
                                                        <a class="dropdown-item deleteData" data-table="restaurants_categories"
                                                            data-uuid="{{ $data->uuid }}"
                                                            href="javascript:void(0)">Delete</a>
>>>>>>>> 5278a15d54d297b514d5e419999275e8d42c3132:resources/views/admin/restaurants-category/list.blade.php
                                                    </div>
