...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Transaction') }}</a>
</li>
@endsection
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">No of Subscribers Customers.: {{ count($users) }}</h1>
                </div><!-- /.col -->
               <!-- /.col -->
            </div>
            <!-- /.row -->
                        ...
                        <table class="table  text-nowrap custom-data-table" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <td>{{ $data->transaction_id }}
                                    ...
                                    <td>{{ $data->paymentType->name}}
                                    </td>
                                  
                                  
                                    <td>{{ date('d-m-Y', strtotime($data->payment_date)) }}</td>
                                    <td style="color:red">{{ $data->plan_expire }}
                                    </td>
