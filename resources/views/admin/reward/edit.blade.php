    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Edit Reward</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.reward.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.reward.edit', $rewardData->uuid) }}" id="customerForm"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="title" class="form-control" type="text" name="title"
                                        placeholder="Title" value="{{ $rewardData->title }}" />
                                    @error('title')
                           ...
                           <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file"  data-check="Email" name="file" id="file" class="form-control requiredCheck" value="{{isset($data)?$data->file:''}}">
                                </div>
                            </div> 
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="10" id="description" name="description">{{ $rewardData->description }}</textarea>
                                    @error('description')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
