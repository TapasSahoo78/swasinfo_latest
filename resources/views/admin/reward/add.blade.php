    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Add Reward</h1>
                    </div><!-- /.col -->
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.reward.add') }}" id="customerForm"
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file"  data-check="Email" name="file" id="file" class="form-control requiredCheck" >
                                </div>
                            </div>
                            {{-- <div class="col-md-4">
                                <div class="form-group">
