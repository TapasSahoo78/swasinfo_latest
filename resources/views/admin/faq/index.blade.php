        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Faqs : {{ count($listFaqs) }}</h1>
                    </div><!-- /.col -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($listFaqs as $data)
                                        <tr>
                                            <td>{{ $data->question ? $data->question : '---' }}
                                            <td>{{ $data->answer ? $data->answer : '---' }}
                                            <td>{{ date('d-m-Y', strtotime($data->created_at)) }}</td>
                                            <td>
                                                @switch($data->is_active)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="faqs"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.faq.edit', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item deleteData" data-table="faqs"
                                                                data-uuid="{{ $data->uuid }}"
