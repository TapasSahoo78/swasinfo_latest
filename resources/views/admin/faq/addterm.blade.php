...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Term and Condition') }}</a>
    </li>
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Term And Condition</h1>
                    </div><!-- /.col -->
                  <!-- /.col -->
                </div>
                <!-- /.row -->
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.cms.term.and.condition') }}" id="customerForm"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control answer" rows="10" cols="50" id="answer" name="answer">{{ $privacy->description }}</textarea>
                                    @error('answer')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
