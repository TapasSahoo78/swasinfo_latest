    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.faq.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.faq.edit', $faqData->uuid) }}" id="customerForm"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="question" class="form-control" type="text" name="question"
                                        placeholder="Question"  value="{{ $faqData->question }}"/>
                                    @error('question')
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="10" id="answer" name="answer">{{ $faqData->answer }}</textarea>
                                    @error('answer')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
