    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.page.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.page.edit', $pageData->uuid) }}" id="customerForm"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="title" class="form-control" type="text" name="title"
                                        placeholder="Title"  value="{{ $pageData->title }}"/>
                                    @error('title')
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="10" id="description" name="description">{{ $pageData->description }}</textarea>
                                    @error('description')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
