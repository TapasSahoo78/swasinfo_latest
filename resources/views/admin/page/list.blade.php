        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Pages : {{ count($listPages) }}</h1>
                    </div><!-- /.col -->
                                    ...
                                    @forelse ($listPages as $data)
                                        <tr>
                                            ...
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="pages"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $data->uuid }}"
                                                            data-table="pages" data-message="active"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.page.edit', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item deleteData" data-table="pages"
                                                                data-uuid="{{ $data->uuid }}"
