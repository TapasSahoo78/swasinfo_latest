...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Product List') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Product : {{ count($listCategories) }}</h1>
                    </div><!-- /.col -->
                                    ...
                                    @forelse ($listCategories as $data)
                                        <tr>
                                            <td>{{ $data->title ? $data->title : '---' }}</td>
                                             <td>{{ $data->category->name  ? $data->category->name  : '---' }}</td>
                                             <td>{{ $data->price  ? $data->price  : '---' }}</td>
                                             <td>{{ $data->color  ? $data->color  : '---' }}</td>
                                             <td>
                                                @switch($data->is_sales)
                                                    @case(1)
                                            ...
                                            <td>{{ $data->createdByUser->first_name  ? $data->createdByUser->first_name  : '---' }} {{ $data->createdByUser->last_name  ? $data->createdByUser->last_name  : '---' }}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.product.edit', $data->uuid) }}">Edit</a>
