...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.subscription.plan.add') }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control" type="text" name="name" placeholder="Plan Name" value="{{ old('name') }}" />
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="frequently_purchased_title" class="form-control" type="text" name="title" placeholder="Plan Title" value="{{ old('frequently_purchased_title') }}" />
                                @error('title')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="expiry_date" class="form-control" type="number" name="expiry_date"  value="{{ old('expiry_date') }}" />
                                @error('expiry_date')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="expiry_date" class="form-control" type="text" name="day_validity"  value="{{ old('day_validity') }}" placeholder="Day Validity" />
                                @error('day_validity')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="course[]" id="" value="{{ $course->id }}"><span class="m-2">{{ $course->name }}</span>
                                    @empty
                                    @endforelse
                                </div>
                                @empty
