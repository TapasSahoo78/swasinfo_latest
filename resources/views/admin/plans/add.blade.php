    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.subscription.plan.add') }}" id="customerForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="frequently_purchased_title" class="form-control" type="text"
                                        ...
                                        value="{{ old('frequently_purchased_title') }}" />
                                    @error('title')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="expiry_date" class="form-control" type="text" name="day_validity"
                                        value="{{ old('day_validity') }}" placeholder="Day Validity" />
                                    @error('day_validity')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input class="m-2" type="checkbox" name="is_ai_only"
                                        value="{{ old('is_ai_only') }}" />
                                </div>
                            </div>
