        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Plans : {{ count($data) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.subscription.plan.add') }}">
                                ...
                                <tbody>
                                    @forelse ($data as $key=>$value)
                                        <tr>
                                            ...
                                            <td>{{ $value->expiry_date ? $value->expiry_date : '---' }}</td>
                                            <td>
                                                @switch($value->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="plans"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $value->uuid }}"
                                                            data-table="plans" data-message="active"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.subscription.plan.edit', $value->uuid) }}">Edit</a>
                                                        <a class="dropdown-item deleteData" data-table="plans"
