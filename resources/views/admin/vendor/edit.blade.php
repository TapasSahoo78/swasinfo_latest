    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Edit Vendor List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.vendor.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.vendor.edit', $user->uuid) }}" id="customerForm"
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <option value="">Select Type.</option>
                                        <option value="1" <?php if ($user->type == '0') {
                                            echo 'selected';
                                        } ?>>Dietitian</option>
                                        <option value="0" <?php if ($user->type == '0') {
                                            echo 'selected';
                                        } ?>>Trainer</option>
                                    </select>
                                    @error('name')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="mobile_number" class="form-control" type="text" name="mobile_number"
                                        placeholder="Last Name" value="{{ $user->mobile_number }}" />
                                    @error('mobile_number')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div class="">
                                    ...
                                    <img class="ml-1" src="{{ $user->customer_picture }}" width="75" height="60"
                                        alt="Icon 01" />
                                </div>
                            </div>
