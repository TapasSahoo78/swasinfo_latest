        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Categories : {{ count($listSubCategories ?? 0) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.restaurant.category.subcategory.add') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($listSubCategories as $data)
                                        <tr>
                                            <td>{{ $data->category?->name ? $data->category?->name : '---' }}
                                                ...
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0"
                                                            data-table="restaurants_categories" data-message="inactive"
                                                            data-uuid="{{ $data->uuid }}"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item deleteData"
                                                            data-table="restaurants_categories"
                                                            data-uuid="{{ $data->uuid }}"
