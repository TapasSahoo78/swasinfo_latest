...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Points') }}</a>
    </li>
@endsection
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Edit Points</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.product.points.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card p-3">
                    ...
                    <form method="post" action="{{ route('admin.product.points.edit', $data->uuid) }}" id="customerForm"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Steps<sup>*</sup></label>
                                    <input id="name" class="form-control" type="text" name="steps"
                                        placeholder="Steps" value="{{ old('steps', $data->steps) }}" />
                                    @error('steps')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="points"
                                        placeholder="Points" value="{{ old('points', $data->points) }}" />
                                    @error('name')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Discounts<sup>*</sup></label>
                                    <input id="name" class="form-control" type="text" name="discount"
                                        placeholder="Discounts" value="{{ old('discount', $data->discount) }}" />
                                    @error('name')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
