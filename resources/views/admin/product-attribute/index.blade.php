        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Points : {{ count($data) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.product.points.add') }}">
                            ...
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($data as $key=>$value)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $value->steps ? $value->steps : '---' }}</td>
                                            <td>{{ $value->points ? $value->points : '---' }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.product.points.edit', $value->uuid) }}">Edit</a>
