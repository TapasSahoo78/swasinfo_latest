                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="flex items-center text-slate-800">
                                        <div
                                            class="w-10 h-10 shrink-0 flex items-center justify-center bg-slate-100 rounded-full mr-2 sm:mr-3">
                                            <img class="ml-1" src="{{ $listTestimonial->user?->profile_picture }}" width="20"
                                                height="20" alt="Icon 01" />
                                        </div>
                                    </div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div>{{ $listTestimonial->description != '' ? substr($listTestimonial->description, 0, 50) . '...' : '---' }}</div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    @switch($listTestimonial->status)
                                        @case(1)
                                            <a href="javascript:void(0)" data-value="0" data-table="reviews" data-message="inactive"
                                                data-uuid="{{ $listTestimonial->uuid }}"
                                        ...
                                        @case(0)
                                            <a href="javascript:void(0)" data-value="1" data-uuid="{{ $listTestimonial->uuid }}"
                                                data-table="reviews" data-message="active"
