...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Trainer & Dietitian') }}</a>
</li>
@endsection
@section('content')
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <option value="">Select Type.</option>
                                    <option value="1" <?php if($user->type == "1"){ echo "selected"; }?>>Dietitian</option>
