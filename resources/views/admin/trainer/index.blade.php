        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Trainers & Dietitian: {{ count($users) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                           <a class="btn btn-primary" href="{{ route('admin.trainer.add') }}">
                                <span><i class="fa fa-plus" aria-hidden="true"></i></span>
                                Add Trainer & Dietitian
                            </a>
                    </div><!-- /.col -->
                </div>
               <!-- /.row -->
                                ...
                                <tbody>
                                     @forelse ($users as $data)
                                        <tr>
                                            ...
                                            <td><img class="ml-1" src="{{ $data->customer_picture }}" width="40"
                                                height="40" alt="Icon 01" /></td>
                                                <td><?php if($data->type =="1"){ echo "Dietitian";}else if($data->type =="0"){ echo "Trainer"; }else if($data->type =="2"){ echo "MPhil";}else if($data->type =="3"){ echo "Yoga";} ?></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.trainer.edit', $data->uuid) }}">Edit</a>
