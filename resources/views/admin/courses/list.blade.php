...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Courses') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Courses : {{ count($listCourses) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.subscription.course.add') }}">
                                    ...
                                    @forelse ($listCourses as $data)
                                        <tr>
                                            ...
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="courses"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $data->uuid }}"
                                                            data-table="courses" data-message="active"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.subscription.course.edit', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item deleteData" data-table="courses"
                                                                data-uuid="{{ $data->uuid }}"
            ...
            buttons: [
                    {
                        ...
                        text: 'Export CSV',
                        exportOptions: {
                            columns: [0,1,2,3] // Define which columns to export (e.g., columns 0 and 2)
                        },
