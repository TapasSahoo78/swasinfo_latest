    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.subscription.course.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.subscription.course.edit',$courseData->uuid) }}" id="customerForm"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        placeholder="Course" value="{{ $courseData->name }}" />
                                    @error('name')
