...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Agent List') }}</a>
</li>
@endsection
@section('content')
<style>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-3">
                    <h1 class="m-0 text-dark">No of Sales Agent: {{ count($users) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-9 right_btn">
                    <div class="file_importbox">
                        <form action="{{ route('admin.agent.import') }}" method="POST" name="importform" enctype="multipart/form-data">
                            @csrf
                            <div class="file_formbox">
                                <div class="form-group">
                                    <label for="file">Sales Agent Import:</label>
                    ...
                    <a class="btn btn-primary" href="{{ route('admin.agent.add') }}">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('admin.agent.edit', $data->uuid) }}">Edit</a>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#dataTable').DataTable({ // Enable search
            ...
            buttons: [{
                    ...
                    text: 'Export CSV',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6, 7] // Define which columns to export (e.g., columns 0 and 2)
                    },
