...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.product.add',$id ) }}"  id="customerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="category_id" class="form-control" name="category_id" readonly>
                                    ...
                                    <option value="{{ $category->id }}" @if (old('category_id')==$category->id || $productId==$category->id) selected @endif">
                                        {{ $category->name }}
                                    </option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control" type="text" name="name" placeholder="Product Name" value="{{ old('name') }}" />
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="title" placeholder="Product Title" value="{{ old('title') }}" />
                                @error('title')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="price" placeholder="Product Price" value="{{ old('price') }}" />
                                @error('price')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="discount" placeholder="Discount Price" value="{{ old('discount') }}" />
                                @error('discount')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="product_color" class="form-control"  name="color" placeholder="Product Color" value="{{ old('color') }}" />
                                @error('color')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="stock" placeholder="Product Stock" value="{{ old('stock') }}" />
                                @error('price')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
