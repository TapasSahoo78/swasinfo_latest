...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Banner List') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Banner : {{ count($listbanner) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.product.addbanner') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($listbanner as $data)
                                        <tr>
                                            <td>{{ $data->title ? $data->title : '---' }}</td>
                                             <td>{{ $data->link  ? $data->link : '---' }}</td>
                                             <td>{{ $data->description  ? $data->description  : '---' }}</td>
                                             <td><img src="{{ asset('images/' . $data->banner_img_file) }}" alt="Your Image" width="200" height="100"></td>
                                             <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.product.editbanner',$data->uuid) }}">Edit</a>
