...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Restaurant List') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Restaurant : {{ count($listRestaurant) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.restaurant.add') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($listRestaurant as $data)
                                        {{-- @dd($data) --}}
                                        <tr>
                                            ...
                                            <td>{{ $data->long ? $data->long : '---' }}</td>
                                            <td>{{ $data->is_featured ? $data->is_featured : '---' }}</td>
                                            

                                            <td>{{ $data->user->first_name ? $data->user->first_name : '---' }}
                                                {{ $data->user->last_name ? $data->user->last_name : '---' }}</td>
                                            <td>{{ $data->user->mobile_number ? $data->user->mobile_number : '---' }}
                                            </td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.product.edit', $data->uuid) }}">Edit</a>
