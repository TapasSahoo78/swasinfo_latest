...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">Add Doctor List</h1>
                </div><!-- /.col -->
                <div class="col-sm-4 right_btn">
                    <a class="btn btn-primary" href="{{ route('admin.doctor.list') }}">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.doctor.add') }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="email" class="form-control" type="text" name="email" placeholder="Email" value="{{ old('email') }}" />
                                @error('email')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="mobile_number" class="form-control" type="text" name="mobile_number" placeholder="Phone" value="{{ old('mobile_number') }}" />
                                @error('mobile_number')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="password" class="form-control" type="password" name="password" placeholder="Password" value="{{ old('password') }}" />
                                @error('password')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="10" id="introduction" name="introduction"></textarea>
                                @error('introduction')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
