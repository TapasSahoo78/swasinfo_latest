...
<li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link custom-cumb">{{ __('Doctor List') }}</a>
</li>
@endsection
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">Edit Doctor List</h1>
                </div><!-- /.col -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.doctor.edit',$user->uuid) }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
