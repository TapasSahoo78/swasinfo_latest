...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Workout') }}</a>
    </li>
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Edit Workout</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.workout.list') }}">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.workout.edit',$data->uuid) }}" id="customerForm"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        placeholder="Workout" value="{{ $data->name }}" />
                                    @error('name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Workout Type<sup>*</sup></label>
                                    <select id="workout_type" class="form-control" name="workout_type">
                                        <option value="">Select Type</option>
                                        <option value="yoga"@if($data->workout_type=='yoga') selected @endif> Yoga</option>
                                        <option value="meditation"@if($data->workout_type=='meditation') selected @endif> Meditation</option>
                                        <option value="exercises"@if($data->workout_type=='exercises') selected @endif> Exercises</option>
                                    </select>
                                    @error('workout_type')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Workout Goal<sup>*</sup></label>
                                    <select id="workout_sub_type" class="form-control" name="workout_sub_type">
                                        <option value="">Select Goal</option>
                                        <option value="muscle_gain"@if($data->workout_sub_type=='muscle_gain') selected @endif>MUSCLE GAIN</option>
                                        <option value="fat_loss"@if($data->workout_sub_type=='fat_loss') selected @endif>FAT LOSS</option>
                                    </select>
                                    @error('workout_sub_type')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                                        </span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Workout Image<sup>*</sup></label>
                                    <input id="workout_image" class="form-control" type="file" name="workout_image"
