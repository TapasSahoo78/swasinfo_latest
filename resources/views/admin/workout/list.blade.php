        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Workouts : {{ count($workouts) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.workout.add') }}">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table id="dataTable" class="text-nowrap custom-data-table">
                                <thead>
                                    <tr>
                                        <th>Workout Name</th>
                                        <th>Workout Type</th>
                                ...
                                <tbody>
                                    @forelse ($workouts as $data)
                                        <tr>
                                            <td>{{ $data->name ? $data->name : '---' }}</td>
                                            <td>{{ $data->workout_type ? $data->workout_type : '---' }}</td>
                                            <td>{{ date('d-m-Y', strtotime($data->created_at)) }}</td>
                                            <td>
                                                @switch($data->status)
                                                    @case(1)
                                                        <a href="javascript:void(0)" data-value="0" data-table="workouts"
                                                    ...
                                                    @case(0)
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="{{ $data->uuid }}"
                                                            data-table="workouts" data-message="active"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="{{ route('admin.workout.edit', $data->uuid) }}">Edit</a>
                                                            <a class="dropdown-item" href="{{ route('admin.workout.view.details', $data->uuid) }}">Create Workout Details</a>
                                                            <a class="dropdown-item deleteData" data-table="workouts"
                                                                data-uuid="{{ $data->uuid }}"
