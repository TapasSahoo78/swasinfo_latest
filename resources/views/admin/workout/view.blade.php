...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb">{{ __('Workout Details') }}</a>
    </li>
@endsection
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Workouts Details : {{ count($workoutDetails) }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="{{ route('admin.workout.create.details', ['uuid' => $uuid]) }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 700px;">
                            <table class="table  text-nowrap custom-data-table" id="dataTable">
                                ...
                                <tbody>
                                    @forelse ($workoutDetails as $data)
                                        <tr>
                                            <td>{{ $data->workout_name ? $data->workout_name : '---' }}</td>
                                            <td>{{ $data->sets ? $data->sets : '---' }}</td>
                                            <td>{{ $data->reps ? $data->reps : '---' }}</td>
                                            <td>{{ $data->calorie ? $data->calorie : '---' }}</td>
