    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Add Workout</h1>
                    </div><!-- /.col -->
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="{{ route('admin.workout.add') }}" id="customerForm"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        placeholder="Workout" value="{{ old('name') }}" />
                                    @error('name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="workout_type" class="form-control" name="workout_type">
                                        ...
                                        <option value="yoga" <?php echo 'yoga' == old('workout_type') ? 'selected' : ''; ?>> Yoga</option>
                                        <option value="meditation" <?php echo 'meditation' == old('workout_type') ? 'selected' : ''; ?>> Meditation</option>
                                        <option value="exercises" <?php echo 'exercises' == old('workout_type') ? 'selected' : ''; ?>> Exercises</option>
                                    </select>
                                    @error('workout_type')
                                        <span class="text-sm text-danger">
                                            {{ $message }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="workout_sub_type" class="form-control" name="workout_sub_type">
                                        ...
                                        <option value="muscle_gain" <?php echo 'muscle_gain' == old('workout_sub_type') ? 'selected' : ''; ?>>MUSCLE GAIN</option>
                                        <option value="fat_loss" <?php echo 'fat_loss' == old('workout_sub_type') ? 'selected' : ''; ?>>FAT LOSS</option>
                                    </select>
