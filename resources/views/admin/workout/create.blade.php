...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">Create Workout Details</h1>
                </div><!-- /.col -->
                <div class="col-sm-4">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="{{ route('admin.workout.create.details', ['uuid' => $uuid]) }}" id="customerForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="workout_id" id="workout_id" value="{{$uuid}}">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Name<sup>*</sup></label>
                                <input id="workout_name" class="form-control" type="text" name="workout_name" placeholder="Workout Name" value="{{ old('workout_name') }}" />
                                @error('workout_name')
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Sets<sup>*</sup></label>
                                <input id="sets" class="form-control" type="text" name="sets" placeholder="Workout Name" value="{{ old('sets') }}" />
                                @error('sets')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Repeats<sup>*</sup></label>
                                <input id="reps" class="form-control" type="text" name="reps" placeholder="Repeats" value="{{ old('reps') }}" />
                                @error('reps')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Calorie<sup>*</sup></label>
                                <input id="reps" class="form-control" type="text" name="calorie" placeholder="calorie" value="{{ old('calorie') }}" />
                                @error('reps')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Workout Details Image<sup>*</sup></label>
                                <input id="workout_details_image" class="form-control" type="file" name="workout_details_image" accept="image/jpeg,image/png,image/jpg,image/gif" />
                                @error('workout_details_image')
                                <span class="text-sm text-danger">
                                    {{ $message }}
                                </span>
                                @enderror
