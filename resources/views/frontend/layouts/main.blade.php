...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/stellarnav.css') }}">
...
<body>
    ...
    <div class="banner-section">
        <div class="owl-carousel banner-carousel owl-theme">
            <div class="item">
                <div class="banner01"><img src="{{ asset('frontend/images/banner01.png') }}" class="img-fluid"
                        alt=""></div>
                <!-- <div id="overlay"></div> -->
                <div class="container">
    ...
    <div class="brainteasergame-section">
        <div class="brainteasergamebg"><img src="{{ asset('frontend/images/teasergames-bg01.png') }}"
                alt=""></div>
        <div class="container">
                    ...
                    <div class="customisedguidance-right">
                        ...
                        <div class="personalisedcard">
                            <div class="personalisedcard-img"><img
                                    src="{{ asset('frontend/images/DietPlan-bg01.png') }}" alt="">
                            </div>
                        ...
                        <div class="personalisedcard">
                            <div class="personalisedcard-img"><img
                                    src="{{ asset('frontend/images/WorkoutRegime.png') }}" alt="">
                            </div>
    ...
    <div class="healthassurance-section">
        <div class="healthassurancebg"><img src="{{ asset('frontend/images/healthassurancebg.png') }}"
                alt=""></div>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="walletsystemimg01"><img src="{{ asset('frontend/images/walletsystemimg01.png') }}"
                        ...
                        <div class="walletsystemimg02"><img
                                src="{{ asset('frontend/images/walletsystemimg02.png') }}" alt=""></div>
                    </div>
                </div>
