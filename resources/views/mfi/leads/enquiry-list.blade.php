        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Enquiry: {{ $listEnquiries->count() }}</h1><br>
                        <b>Name : </b>{{ !empty($lead_details)?$lead_details->name:'---' }}<br>
                                                <b>Phone : </b>{{ !empty($lead_details)?$lead_details->phone:'---' }}<br>
                                                <b>Email : </b>{{ !empty($lead_details)?$lead_details->email:'---' }}
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                        @can('add-enquiries')
