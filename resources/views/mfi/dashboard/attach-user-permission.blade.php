...
@section('pagetitlesection')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ Route::currentRouteName() }}" class="nav-link custom-cumb">{{ __('Attach User Permission') }}</a>
    </li>
@endsection
@section('content')
                            ...
                            <div class="card p-3">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" class="form-checkbox" name="permission[]" value="view-dashboard"
                                        @if ($userData->hasUserPermission('view-dashboard')) checked @endif />
                                            ...
                                            <div class="p-2">
                                                ...
                                                <label class="flex items-center">
                                                    <input type="checkbox" class="form-checkbox" name="permission[]"
                                                        ...
                                                        @if ($userData->hasUserPermission($permission->slug)) checked @endif />
