            ...
            <div class="row">
                <div class="col-md-2 col-7">
                    <div class="logo"> <a class="navbar-brand" href="index.html"><img class=""
                                src="<?php echo e(asset('frontend/images/logo.png')); ?>" alt="" title="SwaasthFiit" /></a>
                    </div>
                </div>
                <div class="col-md-10 col-5">
                    <div id="main-nav" class="stellarnav">
                        <ul>
                            ...
                            <li><a href="#" class="loginbtn2">Buy Product</a></li>
...
<?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/frontend/layouts/main.blade.php ENDPATH**/ ?>