    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Add Vendor List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="<?php echo e(route('admin.vendor.list')); ?>">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="<?php echo e(route('admin.vendor.add')); ?>" id="customerForm"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="mobile_number" class="form-control" type="text" name="mobile_number"
                                        placeholder="Phone" value="<?php echo e(old('mobile_number')); ?>" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/admin/vendor/add.blade.php ENDPATH**/ ?>