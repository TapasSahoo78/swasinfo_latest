<?php $__env->startSection('content'); ?>
    ...
    <div class="banner-section">
        <div class="owl-carousel banner-carousel owl-theme">
            <div class="item">
                <div class="banner01"><img src="<?php echo e(asset('frontend/images/banner01.png')); ?>" class="img-fluid" alt="">
                </div>
                <!-- <div id="overlay"></div> -->
                <div class="container">
                    <div class="bannercarousel-text wow animate fadeInLeft">
                        ...
                        <a href="#" class="btn-download">Download Free App</a> <a href="<?php echo e(route('frontend.signup')); ?>"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="fitnessgoal-sect">
                        <div class="fitnessgoal-card">
                            <img src="<?php echo e(asset('frontend/images/goal-img01.png')); ?>" alt="">
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="fitnessgoal-sect">
                        <div class="fitnessgoal-card">
                            <img src="<?php echo e(asset('frontend/images/goal-img02.png')); ?>" alt="">
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="fitnessgoal-sect">
                        <div class="fitnessgoal-card">
                            <img src="<?php echo e(asset('frontend/images/goal-img03.png')); ?>" alt="">
                            <div class="content">
                                <h3>Diet & Food Recipes</h3>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="fitnessgoal-sect">
                        <div class="fitnessgoal-card">
                            <img src="<?php echo e(asset('frontend/images/goal-img04.png')); ?>" alt="">
                            <div class="content">
            ...
            <section>
                ...
                <div class="content">
                    <div class="accordion">
                        ...
                        <div class="title active" data-image="<?php echo e(asset('frontend/images/featuresimg01.png')); ?>">
                            Body Scan
                        </div>
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/foodscan-01.png')); ?>">
                            Food Scan
                        </div>
                        <div class="desc">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/GenderDetectionimg01.png')); ?>">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/BMIPredictionimg01.png')); ?>">
                            BMI Prediction
                        </div>
                        <div class="desc">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/SymptomPrediction-img01.png')); ?>">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/FaceEmotion-img01.png')); ?>">
                    ...
                    <div class="image">
                        <img src="<?php echo e(asset('frontend/images/featuresimg01.png')); ?>">
                    </div>
                </div>
    ...
    <div class="brainteasergame-section">
        <div class="brainteasergamebg"><img src="<?php echo e(asset('frontend/images/teasergames-bg01.png')); ?>" alt=""></div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="customisedguidance-left">
                        <div class="dguidanceicon"><img src="<?php echo e(asset('frontend/images/guidance-icon.png')); ?>"
                                alt=""></div>
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="customisedguidance-right">
                        ...
                        <div class="personalisedcard">
                            <div class="personalisedcard-img"><img src="<?php echo e(asset('frontend/images/DietPlan-bg01.png')); ?>"
                                    alt="">
                            </div>
                        ...
                        <div class="personalisedcard">
                            <div class="personalisedcard-img"><img src="<?php echo e(asset('frontend/images/WorkoutRegime.png')); ?>"
                                    alt="">
                            </div>
                        ...
                        <div class="personalisedcard">
                            <div class="personalisedcard-img"><img
                                    src="<?php echo e(asset('frontend/images/WorkoutRegime02.png')); ?>" alt="">
                            </div>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="fitnessleft">
                        <img src="<?php echo e(asset('frontend/images/fitnessleft-img01.png')); ?>" alt="">
                    </div>
                </div>

                <div class="col-lg-5 col-md-5 col-12">
                    <div class="fitnessright">
                        <div class="fitnessrighticon"><img src="<?php echo e(asset('frontend/images/Basedimg01.png')); ?>"
                                alt=""></div>
                        <h2>Fitness pause</h2>
    ...
    <div class="healthassurance-section">
        <div class="healthassurancebg"><img src="<?php echo e(asset('frontend/images/healthassurancebg.png')); ?>" alt="">
        </div>

        <div class="container">
            <div class="healthassurance-left">
                <div class="healthassurance-right"><img src="<?php echo e(asset('frontend/images/healthassurance-02.png')); ?>"
                        alt=""></div>
                <div class="dhealthassuranceicon"><img src="<?php echo e(asset('frontend/images/Basedimg01.png')); ?>"
                        alt=""></div>
    ...
    <div class="features-section features-section2">
        <div class="container">
            ...
            <section>
                ...
                <div class="content">
                    <div class="accordion">
                        <div class="title active" data-image="<?php echo e(asset('frontend/images/StepsTracking-img01.png')); ?>">
                            Steps Tracking
                        </div>
                        <div class="desc active">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/CalorieTracking-img01.png')); ?>">
                            Calorie Tracking
                        </div>
                        <div class="desc">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/FoodTracking-img01.png')); ?>">
                            Food Tracking
                        </div>
                        <div class="desc">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/BodyMeasurement-img01.png')); ?>">
                        ...
                        <div class="title" data-image="<?php echo e(asset('frontend/images/Gamelevels-img01.png')); ?>">
                            Game levels
                        </div>
                        <div class="desc">
                    ...
                    <div class="image">
                        <img src="<?php echo e(asset('frontend/images/StepsTracking-img01.png')); ?>">
                    </div>
                </div>
    ...
    <div class="customisedguidance-section walletsystem">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="customisedguidance-left">
                        <div class="dguidanceicon"><img src="<?php echo e(asset('frontend/images/wallet-icon.png')); ?>"
                                alt=""></div>
                        <h3>Wallet System</h3>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="walletsystemimg01"><img src="<?php echo e(asset('frontend/images/walletsystemimg01.png')); ?>"
                            alt="">
                        <div class="walletsystemimg02"><img src="<?php echo e(asset('frontend/images/walletsystemimg02.png')); ?>"
                                alt=""></div>
                    </div>
                </div>
    ...
    <div class="videocontent-section">
        <div class="squareeffect"><img src="<?php echo e(asset('frontend/images/SquareEffect.png')); ?>" alt=""></div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="thetlanfit-sect active">
                        ...
                        <ul>
                            <li><span><img src="<?php echo e(asset('frontend/images/Arrow-right.png')); ?>" class=""
                                        alt=""></span> AI
    ...
    <div class="meetourteam-section">
        <div class="container">
            ...
            <div class="meeteam-sect">
                <img src="<?php echo e(asset('frontend/images/meeteam-sect01.png')); ?>" alt="">
                <h2>Meet Our Team</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg01.png')); ?>"
                                alt=""></div>
                        <h4>Rakhi Dutta</h4>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg02.png')); ?>"
                                alt=""></div>
                        <h4>Anirudh Das</h4>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg03.png')); ?>"
                                alt=""></div>
                        <h4>Abhhijit Das</h4>
                        <h4><b>Founder</b></h4>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg04.png')); ?>"
                                alt=""></div>
                        <h4>Titiksha Shri</h4>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg05.png')); ?>"
                                alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg06.png')); ?>"
                                alt=""></div>
                        <h4>Amit Sharma</h4>
                        <h4><b>Advocate</b></h4>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg07.png')); ?>"
                                alt=""></div>
                        <h4>Raja Pathak</h4>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="meeteamcard">
                        <div class="meeteamimg"><img src="<?php echo e(asset('frontend/images/meeteamimg08.png')); ?>"
                                alt=""></div>
                        <h4>Ashish Singh</h4>
                        <h4><b>Fitness Coach</b></h4>
                    </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/frontend/pages/homepage.blade.php ENDPATH**/ ?>