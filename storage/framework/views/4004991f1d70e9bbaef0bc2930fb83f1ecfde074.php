...
<div class="banner-section">
    <div class="owl-carousel banner-carousel owl-theme">
        <div class="item">
            <div class="banner01"><img src="<?php echo e(asset('frontend/images/banner01.png')); ?>" class="img-fluid"
                    alt=""></div>
            <!-- <div id="overlay"></div> -->
            <div class="container">
                <div class="bannercarousel-text wow animate fadeInLeft">
                    ...
                    <a href="#" class="btn-download">Download Free App</a> <a href="#"
...
<div class="features-section">
    <div class="container">
        ...
        <section>
            ...
            <div class="content">
                <div class="accordion">
                    <div class="line01"><img src="<?php echo e(asset('frontend/images/line01.png')); ?>" alt="">
                    </div>
                    <div class="title active" data-image="images/featuresimg01.png')}}">
                        Body Scan
                    </div>
                    ...
                    <div class="title" data-image="images/foodscan-01.png')}}">
                        Food Scan
                    </div>
                    <div class="desc">
                    ...
                    <div class="title" data-image="images/GenderDetectionimg01.png')}}">
                    ...
                    <div class="title" data-image="images/BMIPredictionimg01.png')}}">
                        BMI Prediction
                    </div>
                    <div class="desc">
                    ...
                    <div class="title" data-image="images/SymptomPrediction-img01.png')}}">
                    ...
                    <div class="title" data-image="images/FaceEmotion-img01.png')}}">
...
<div class="brainteasergame-section">
    <div class="brainteasergamebg"><img src="<?php echo e(asset('frontend/images/teasergames-bg01.png')); ?>"
            alt=""></div>
    <div class="container">
                ...
                <div class="customisedguidance-right">
                    ...
                    <div class="personalisedcard">
                        <div class="personalisedcard-img"><img
                                src="<?php echo e(asset('frontend/images/DietPlan-bg01.png')); ?>" alt="">
                        </div>
                    ...
                    <div class="personalisedcard">
                        <div class="personalisedcard-img"><img
                                src="<?php echo e(asset('frontend/images/WorkoutRegime.png')); ?>" alt="">
                        </div>
...
<div class="healthassurance-section">
    <div class="healthassurancebg"><img src="<?php echo e(asset('frontend/images/healthassurancebg.png')); ?>"
            alt=""></div>
...
<div class="features-section features-section2">
    <div class="container">
        ...
        <section>
            ...
            <div class="content">
                <div class="accordion">
                    <div class="title active" data-image="images/StepsTracking-img01.png')}}">
                        Steps Tracking
                    </div>
                    <div class="desc active">
                    ...
                    <div class="title" data-image="images/CalorieTracking-img01.png')}}">
                        Calorie Tracking
                    </div>
                    <div class="desc">
                    ...
                    <div class="title" data-image="images/FoodTracking-img01.png')}}">
                        Food Tracking
                    </div>
                    <div class="desc">
                    ...
                    <div class="title" data-image="images/BodyMeasurement-img01.png')}}">
                    ...
                    <div class="title" data-image="images/Gamelevels-img01.png')}}">
                        Game levels
                    </div>
                    <div class="desc">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="walletsystemimg01"><img src="<?php echo e(asset('frontend/images/walletsystemimg01.png')); ?>"
                        alt="">
                    <div class="walletsystemimg02"><img
                            src="<?php echo e(asset('frontend/images/walletsystemimg02.png')); ?>" alt=""></div>
                </div>
            </div>
