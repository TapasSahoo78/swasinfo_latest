                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-5 align-items-center row">
                        <button class="model-slide-btn" id="addbranch-btn"
                            onclick="window.location='<?php echo e(route('vendor.other.product.add')); ?>'">
                            ...
                            <div class="table table-responsive" style="height:410px">
                                <table class="table  text-nowrap custom-data-table" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td><img src="<?php echo e(asset('assets/images/no-logo.jpg')); ?>" alt=""
...
<?php echo $__env->make('vendor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/vendor/pages/product/list.blade.php ENDPATH**/ ?>