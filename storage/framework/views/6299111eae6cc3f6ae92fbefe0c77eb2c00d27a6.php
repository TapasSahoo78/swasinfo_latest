...
<?php $__env->startSection('pagetitlesection'); ?>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb"><?php echo e(__('Points')); ?></a>
    </li>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Points : <?php echo e(count($data)); ?></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="<?php echo e(route('admin.product.points.add')); ?>">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($value->steps ? $value->steps : '---'); ?></td>
                                            <td><?php echo e($value->points ? $value->points : '---'); ?></td>
                                            <td><?php echo e($value->discount ? $value->discount : '---'); ?></td>
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('admin.product.points.edit', $value->uuid)); ?>">Edit</a>
                                                        <a class="dropdown-item deleteData" data-table="attributes"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/admin/product-attribute/index.blade.php ENDPATH**/ ?>