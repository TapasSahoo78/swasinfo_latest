...
<?php $__env->startSection('pagetitlesection'); ?>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb"><?php echo e(__('Brand')); ?></a>
    </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Recent Assets -->
                <div class="card p-3">
                    <form method="post" action="<?php echo e(route('admin.product.category.add')); ?>" id="customerForm"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        placeholder="Brand" value="<?php echo e(old('name')); ?>" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="category_image" class="form-control" type="file" name="category_image"
                                        placeholder="Category" value="<?php echo e(old('category_image')); ?>" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/admin/product-category/add.blade.php ENDPATH**/ ?>