...
<div class="content-wrapper">
    ...
    <?php endif; ?>
                <div class="col-sm-9 right_btn">
                    <div class="file_importbox">
                        <form action="<?php echo e(route('admin.product.addimport',$id)); ?>" method="POST" name="importform" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- Recent Assets -->
            <div class="card p-3">
                <form method="post" action="<?php echo e(route('admin.product.add',$id )); ?>"  id="customerForm" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="category_id" class="form-control" name="category_id" readonly>
                                    ...
                                    <option value="<?php echo e($category->id); ?>" <?php if(old('category_id')==$category->id || $productId==$category->id): ?> selected <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control" type="text" name="name" placeholder="Product Name" value="<?php echo e(old('name')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="title" placeholder="Product Title" value="<?php echo e(old('title')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Normal Price<sup>*</sup></label>
                                <input id="price" class="form-control"  name="price" placeholder="Product Price" value="<?php echo e(old('price')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="discount" placeholder="Discount Price" value="<?php echo e(old('discount')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="product_color" class="form-control"  name="color" placeholder="Product Color" value="<?php echo e(old('color')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option value="yes" <?php if(old('is_featured') == 'yes'): ?> selected <?php endif; ?>>Featured</option>
                                <option value="no" <?php if(old('is_featured') == 'no'): ?> selected <?php endif; ?>>Not Featured
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control"  name="stock" placeholder="Product Stock" value="<?php echo e(old('stock')); ?>" />
                                <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/admin/product/add-product.blade.php ENDPATH**/ ?>