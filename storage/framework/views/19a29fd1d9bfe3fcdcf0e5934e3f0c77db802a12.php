 ...
 <nav class="mt-2">
     <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <?php endif; ?>
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add-trainers-dietitian', 'list-trainers-dietitian', 'edit-trainers-dietitian',
        ...
        ?>
         ...
         <?php endif; ?>
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add-courses', 'list-courses', 'edit-courses', 'delete-courses', 'add-plans', 'list-plans',
         ...
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['vendor'])): ?>
             <li class="nav-item has-treeview">
                 <a href="<?php echo e(route('admin.contact-us.list')); ?>" class="nav-link">
                     <p>
                         Contact Us List
                     </p>
                 </a>
 ...
 <!-- /.sidebar-menu -->
<?php /**PATH C:\xampp\htdocs\webalizer\swasinfo_latest\resources\views/admin/layouts/partials/sidebar.blade.php ENDPATH**/ ?>