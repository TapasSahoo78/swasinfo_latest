...
<?php $__env->startSection('pagetitlesection'); ?>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link custom-cumb"><?php echo e(__('CATEGORY')); ?></a>
    </li>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">No of Category : <?php echo e(count($data)); ?></h1>
                    </div><!-- /.col -->
                    <?php if(auth()->user()->id == 1){ ?>
                    <div class="col-sm-4 right_btn">
                        <a class="btn btn-primary" href="<?php echo e(route('admin.product.category.add')); ?>">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($value->name ? $value->name : '---'); ?>

                                            <td><?php echo e($value->description ? $value->description : '---'); ?>

                                            <td><img src="<?php echo e(asset('images/' . $value->category_image)); ?>" alt="Your Image" width="200" height="100">
                                            <td>
                                                <?php switch($value->is_active):
                                                    case (1): ?>
                                                        <a href="javascript:void(0)" data-value="0" data-table="categories"
                                                            data-message="inactive" data-uuid="<?php echo e($value->uuid); ?>"
                                                            class="active-status changeStatus ">Active</a>
                                                    <?php break; ?>

                                                    <?php case (0): ?>
                                                        <a href="javascript:void(0)" data-value="1" data-uuid="<?php echo e($value->uuid); ?>"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('admin.product.category.edit', $value->uuid)); ?>">Edit</a>
                                                        <a class="dropdown-item deleteData" data-table="categories"
                                                            data-uuid="<?php echo e($value->uuid); ?>"
                                                            href="javascript:void(0)">Delete</a>
                                                            <a class="dropdown-item"
                                                            href="<?php echo e(route('admin.product.add',$value->uuid)); ?>">Add Product</a>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\DECEMBER-2024\SWASINFO(latest)\shyamfuturetech-swasthafit(latest)\resources\views/admin/product-category/index.blade.php ENDPATH**/ ?>